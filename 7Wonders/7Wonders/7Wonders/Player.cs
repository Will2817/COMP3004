            ...
            JObject j = new JObject(
                ...
                new JProperty("score",
                    new JObject(
                        ...
                        new JProperty(((int)Score.COIN).ToString(), score[Score.COIN]),
                        ...
                        new JProperty(((int)Score.STAGES).ToString(), score[Score.STAGES]),
                        new JProperty(((int)Score.COMMERCE).ToString(), score[Score.COMMERCE]),
                        new JProperty(((int)Score.GUILD).ToString(), score[Score.GUILD]),
                        new JProperty(((int)Score.SCIENCE).ToString(), score[Score.SCIENCE]))),
